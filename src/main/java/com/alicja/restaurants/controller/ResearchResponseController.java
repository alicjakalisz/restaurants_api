...
public class ResearchResponseController {
    ...
    public ResponseEntity<List<ResearchResponseDto>> getResearchResults(@RequestParam(value = "location", required = true) String location,
        ...
        List<ResearchResponseDto> result = researchResponseService.getResearchResults( location, Optional.ofNullable(cuisine),Optional.ofNullable(radius),Optional.ofNullable(rating));
